...
import { fetchMoviesByGenre, setPage } from '../store/slices/moviesSlice';
...
const MoviesByGenre: React.FC = () => {
  ...
  }, [dispatch, genre, pagination.page]);
    ...
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          <div className="text-gray-500 text-lg">No movies found for {genre}</div>
        </div>
      ) : (
        <>
